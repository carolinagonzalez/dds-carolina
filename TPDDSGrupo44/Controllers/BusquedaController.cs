...
namespace TPDDSGrupo44.Controllers
{
    public class BusquedaController : ApiController
    {
        ...
        Busqueda[] busquedas = new Busqueda[] {
            new Busqueda {  fecha = DateTime.Parse("2015-06-10T07:34:42-5:00"), usuarioTerminal = new Terminal("JPerez"), textoBuscado = "texto buscado 1",  poisEncontrados = puntosDeInteres},
            new Busqueda {  fecha = DateTime.Parse("2015-06-10T07:34:42-5:00"), usuarioTerminal = new Terminal("JPerez"), textoBuscado = "texto buscado ",  poisEncontrados = puntosDeInteres},
            new Busqueda {  fecha = DateTime.Parse("2015-06-10T07:34:42-5:00"), usuarioTerminal = new Terminal("JPerez"), textoBuscado = "texto buscado ",  poisEncontrados = puntosDeInteres},
            new Busqueda {  fecha = DateTime.Parse("2015-06-10T07:34:42-5:00"), usuarioTerminal = new Terminal("JPerez"), textoBuscado = "texto buscado ",  poisEncontrados = puntosDeInteres}
        };
